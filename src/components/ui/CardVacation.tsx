...
const CardVacation: React.FC<CardProps> = ({ title, image, day, price, rating }) => {
    return (
        <div className="snap-start shrink-0 flex flex-col bg-white border border-gray-100 rounded-2xl shadow-md w-[300px] sm:w-[370px] h-[400px] overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-xl hover:shadow-primary-light/20 hover:cursor-pointer">
